    ...
    <section className="py-16 sm:py-24 bg-gradient-surface">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          <div className="bg-cb-surface border border-cb-orange/20 rounded-2xl p-5 sm:p-8 lg:p-10 relative overflow-hidden group hover:border-cb-orange/40 transition-all">
          ...
          <div className="bg-cb-surface border border-green-500/20 rounded-2xl p-5 sm:p-8 lg:p-10 relative overflow-hidden group hover:border-green-500/40 transition-all">
